...
from FCNmotif import FCN1
from datasets import EPIDataSetTrain1, EPIDataSetTest1
...
def get_args():
    ...
    parser.add_argument("-c", dest="checkpoint", type=str, default='/home/sc3/users/xu/MotifC/newmodels/',
...
def main():
    ...
    seqs1, seqs2, seqs3, seqs4, label = Data['data1'], Data['data2'], Data['data3'], Data['data4'], Data['label']  # 导入数据
    cv_num = 5
    ...
    for cv in range(cv_num):
        ...
        data_tr3 = seqs3[index_train]
        data_tr4 = seqs4[index_train]
        label_tr = label[index_train]
        train_data = EPIDataSetTrain1(data_tr1, data_tr2, data_tr3, data_tr4, label_tr)
        ...
        data_te3 = seqs3[index_test]
        data_te4 = seqs4[index_test]
        label_te = label[index_test]
        test_data = EPIDataSetTest1(data_te1, data_te2, data_te3, data_te4, label_te)
