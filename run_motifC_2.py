...
from FCNmotif import FCN2
from datasets import EPIDataSetTrain2, EPIDataSetTest2
...
def main():
    ...
    seqs1, seqs2, seqs3, label = Data['data1'], Data['data2'], Data['data3'], Data['label']  # 导入数据
    cv_num = 5
    ...
    for cv in range(cv_num):
        ...
        train_data = EPIDataSetTrain2(data_tr1, data_tr2, data_tr3, label_tr)
        ...
        test_data = EPIDataSetTest2(data_te1, data_te2, data_te3, label_te)
